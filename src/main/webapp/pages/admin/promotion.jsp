...
<head>
    ...
    <title>SkyBooking - Promotion</title>
    <!-- General CSS Files -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Add Promotion for the <%=flight.getPlane().getPlaneModel().getName() %> from <%=flight.getStartCity().getName()%> to <%=flight.getDestinationCity().getName()%></h4>
                        </div>
                        <div class="card-body">
                            <form action="<%=root%>/app/flights/promotions/add" method="get">
                                <input type="hidden" name="Promotion:idFlight" value="<%=flight.getId() %>">

                                <div class="section-title">Plane</div>
                                <div class="form-group">
                                    <label>Class</label>
                                    <select class="form-control select2" name="Promotion:idPlace">
                                        <% for (PlaceType value : places) { %>
                                        <option value="<%=value.getId()%>"><%=value.getName()%> - <%=value.getAvailable()%></option>
                                        <% } %>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Promotion:placeNumber" class="form-control">
                                </div>

                                <div class="form-group">
                                    <label>Promotion</label>
                                    <input type="text" name="Promotion:promotion" class="form-control">
                                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    <form action="<%=root %>/app/flights/promotions/delete" method="get" style="display: inline;">
